...
c.configure(bg='#320d3e', highlightthickness=0)
...
tongue_main = c.create_rectangle(170,250,230,290, outline='#f162ff', fill='#f162ff', state=HIDDEN)
tongue_tip = c.create_oval(170,285,230,300, outline='#f162ff', fill='#f162ff', state=HIDDEN)
